...
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(467);
...
/* harmony import */ var jwt_decode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(680);
...
const getBearer = async (tokenHost, apikey) => {
    ...
    const response = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()(tokenHost, { method: 'POST', body: params });
...
const uploadVersion = async (token, host, filename, channelId, version) => {
    ...
    const content = (0,fs__WEBPACK_IMPORTED_MODULE_2__.readFileSync)(filename, 'utf8');
    ...
    const fetchResponse = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()(host, { method: 'POST', headers: headers, body: JSON.stringify(request) })
...
async function main() {
    try {
        ...
        const apikey = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('apikey');
        if ( !apikey ) {
            throw new Error('Missing apikey');
        }

        const tokenHost = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('tokenHost');
        const bearer = await getBearer(tokenHost, apikey);

        // upload the file
        const host = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('satelliteHost'); 
        const filename = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('filename');
        const channelId = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('channelUuid');
        const versionName = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('versionName');
        const versionid = await uploadVersion(bearer, host, filename, channelId, versionName);

        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)("versionid", versionid);
    } catch (error) {
...
var atob = __webpack_require__(188);
...
var base64_url_decode = __webpack_require__(601);
